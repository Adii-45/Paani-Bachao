...
- No official IMD long-period annual-normal dataset is committed. The provider and ingestion boundary are implemented, but rainfall-dependent assessment is unavailable until an authorized dataset is imported with its reference period and resolution.
